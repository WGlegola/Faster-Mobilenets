...
def parse_args():
    ...
    parser.add_argument('--rec-train', type=str, default='C:\\imagenet\\rec\\train.rec',
                        help='the training data')
    parser.add_argument('--rec-train-idx', type=str, default='C:\\imagenet\\rec\\train.idx',
                        help='the index of training data')
    parser.add_argument('--rec-val', type=str, default='C:\\imagenet\\rec\\val.rec',
                        help='the validation data')
    parser.add_argument('--rec-val-idx', type=str, default='C:\\imagenet\\rec\\val.idx',
...
def main():
    ...
    filehandler = logging.FileHandler(model_name+".log")
