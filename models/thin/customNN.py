    ...
    def __init__(self, multiplier=1.0, classes=1000, **kwargs):
        ...
        with self.name_scope():
            ...
            with self.features.name_scope():
                ...
                _add_conv_dw(self.features, dw_channels=32, channels=32, stride=1)
                _add_conv_dw(self.features, dw_channels=32, channels=64, stride=2)
                _add_conv_dw(self.features, dw_channels=64, channels=128, stride=1)
                _add_conv_dw(self.features, dw_channels=128, channels=128, stride=2)
                _add_conv_dw(self.features, dw_channels=128, channels=256, stride=1)
                _add_conv_dw(self.features, dw_channels=256, channels=256, stride=2)
                _add_conv_dw(self.features, dw_channels=256, channels=512, stride=2)
                _add_conv_dw(self.features, dw_channels=512, channels=1024, stride=1)
